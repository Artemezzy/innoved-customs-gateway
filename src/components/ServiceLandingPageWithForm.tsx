...
import { CheckCircle, Phone, ArrowLeft, ClipboardList, Search, FileText, ScanLine, PackageCheck } from 'lucide-react';
...
interface ServiceLandingPageWithFormProps {
  slug: string;
...
const otherServices = {
  ru: [
    ...
    { slug: 'customs-letters', title: 'Подготовка писем в таможенные органы' },
    { slug: 'inspection', title: 'Организация досмотра товаров' },
  ...
  en: [
    ...
    { slug: 'customs-letters', title: 'Customs Authority Letters' },
    { slug: 'inspection', title: 'Cargo Inspection' },
    { slug: 'translation', title: 'Document Translation' },
  ],
};

export default function ServiceLandingPageWithForm({ slug, whyItems, stepIcons = defaultStepIcons }: ServiceLandingPageWithFormProps) {
            ...
            <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-12">
              ...
              <div className="lg:w-2/5 w-full max-w-md lg:max-w-none">
                <div className="bg-black/40 backdrop-blur-md rounded-xl shadow-2xl overflow-hidden border border-white/10">
                  <QuickContactForm language={language} serviceName={service.title[language]} />
                </div>
              </div>
            </div>
