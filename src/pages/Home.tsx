      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex flex-col">
          ...
          height: '16%'
            ...
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-foreground mt-[8px] mr-0 pr-[10px] pl-[10px] mb-px ml-[11px]">
              {t.whyUs.title}
            </h2>
          ...
          height: '20%'
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {t.services.items.map((service, index) => <Link key={index} to="/services" className="bg-white/90 hover:bg-white px-4 py-3 rounded-lg text-sm font-medium text-foreground shadow-sm hover:shadow-md transition-all duration-200 flex items-center gap-2">
