          ...
          >
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex flex-col max-w-md">
                ...
                <Link
                  to="/about"
                  className="mt-3 md:mt-4 inline-flex self-center px-5 md:px-6 py-2 md:py-2.5 text-white font-medium rounded-md transition-colors duration-200 text-xs sm:text-sm hover:opacity-90 border border-white/30"
