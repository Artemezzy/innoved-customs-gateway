        ...
        <div className="absolute inset-0 flex flex-col">
          ...
          height: '20%'
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {t.services.items.map((service, index) => <Link key={index} to="/services" className="py-3 rounded-lg font-medium shadow-sm hover:shadow-md transition-all duration-200 flex items-center gap-2 px-[100px] text-4xl text-white my-0 mx-[2px] pr-[10px] mr-[600px] text-left bg-white/0">
